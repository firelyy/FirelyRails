...
class EventUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_user" do
    assert_difference('EventUser.count') do
      post event_users_url, params: { event_user: { event_id: @event_user.event_id, user_id: @event_user.user_id } }, as: :json
    end
  ...
  test "should update event_user" do
    patch event_user_url(@event_user), params: { event_user: { event_id: @event_user.event_id, user_id: @event_user.user_id } }, as: :json
    assert_response 200
  end
